...
public interface GlobalTopicConstants {
    ...
    String TOPIC_ID_SHOW_PROFILE_INFO_DIALOG = "GlobalTopicConstants:TOPIC_ID_SHOW_PROFILE_INFO_DIALOG";
    ...
    String PARAM_PROFILE_INFO_DIALOG_SOURCE = "PARAM_PROFILE_INFO_DIALOG_SOURCE";
