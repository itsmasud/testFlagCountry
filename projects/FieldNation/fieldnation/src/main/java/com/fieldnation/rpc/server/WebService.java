    ...
    private class HttpProcessor implements Runnable {
        ...
        public void run() {
            ...
            if (misc.isEmptyOrNull(username)) {
                doHttpError(rr, resultCode, ERROR_NO_USERNAME, "No username supplied!");
                return;
            }
            ...
            if (auth == null) {
                doHttpError(rr, resultCode, errorType, errorMessage);
                return;
            }
            ...
            svc.stopSelf(startId);
        }
    }

    private void doHttpError(ResultReceiver rr, int resultCode, String errorType, String message) {
        Bundle bundle = new Bundle();
