...
public interface WorkorderConstants {
    ...
    String TOPIC_ID_UPLOAD_DELIVERABLE_PROGRESS = "WorkorderConstants:TOPIC_ID_UPLOAD_DELIVERABLE_PROGRESS";
    String TOPIC_ID_CACHE_DELIVERABLE_START = "WorkorderConstants:TOPIC_ID_CACHE_DELIVERABLE_START";
    String TOPIC_ID_CACHE_DELIVERABLE_END = "WorkorderConstants:TOPIC_ID_CACHE_DELIVERABLE_END";
    ...
    String PARAM_POS = "PARAM_POS";
    String PARAM_SIZE = "PARAM_SIZE";
    String PARAM_TIME = "PARAM_TIME";
