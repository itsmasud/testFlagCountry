...
public class SendToDialog extends DialogFragmentBase {
    private static final String TAG = "SendToDialog";
    ...
    /*-				Life Cycle				-*/
    /*-*************************************-*/
    public static SendToDialog getInstance(FragmentManager fm, String tag) {
        return getInstance(fm, tag, SendToDialog.class);
    }
