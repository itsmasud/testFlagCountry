    ...
    private final View.OnClickListener _this_onClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (_notification.getWorkorder() != null && _notification.getWorkorder().getWorkorderId() != null) {
                WorkOrderActivity.startNew(getContext(), _notification.getWorkorder().getWorkorderId().intValue());
            } else if (_notification.getWorkorderId() != null) {
                WorkOrderActivity.startNew(getContext(), _notification.getWorkorderId().intValue());
            } else if (_span != null) {
