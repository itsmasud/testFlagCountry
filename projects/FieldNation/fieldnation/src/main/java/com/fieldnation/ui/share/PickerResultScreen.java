...
public class PickerResultScreen extends RelativeLayout {
    ...
    public PickerResultScreen(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PickerResultScreen(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        public boolean onComplete(UUIDGroup uuidGroup, TransactionParams transactionParams, String methodName, Object successObject, boolean success, Object failObject, boolean isCached) {
            ...
            if (methodName.equals("getWorkOrders")) {
                ...
                if (envelope.getTotal() == 0) {
                    ...
                    _adapter.addObjects(envelope.getPage(), list);
                } else {
