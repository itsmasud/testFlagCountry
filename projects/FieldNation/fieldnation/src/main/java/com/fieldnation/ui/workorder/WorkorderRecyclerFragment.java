...
public class WorkorderRecyclerFragment extends Fragment implements TabActionBarFragmentActivity.TabFragment {
    private static final String TAG_BASE = "WorkorderRecyclerFragment";
    ...
    public WorkorderRecyclerFragment() {
        super();
        _timeHeaderAdapter.setRateMeAllowed(true);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "onCreate: " + WorkorderRecyclerFragment.this.toString() + "/" + _displayView.getCall());
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        _recycler = (OverScrollRecyclerView) view.findViewById(R.id.workorders_listview);
        _recycler.setLayoutManager(new LinearLayoutManager(view.getContext()));
        _recycler.setAdapter(_timeHeaderAdapter);
        _recycler.setOnOverScrollListener(_loadingView);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "onActivityCreated: " + WorkorderRecyclerFragment.this.toString() + "/" + _displayView.getCall());
    }
...
//    }
    ...
    public void onResume() {
        ...
        if (_workorderClient != null && _workorderClient.isConnected()) {
            _timeHeaderAdapter.refreshPages();
        }
...
////        } else {
////            WorkorderClient.list(App.get(), _displayView, page + 1, false, false);
////        }
//        _timeHeaderAdapter.addWorkorders(list);
...
//    }
    ...
    private void doCheckin() {
        ...
        setLoading(true);
        _timeHeaderAdapter.notifyDataSetChanged();
...
//    };
    ...
    private final TimeHeaderAdapter _timeHeaderAdapter = new TimeHeaderAdapter(_wocv_listener) {
        @Override
