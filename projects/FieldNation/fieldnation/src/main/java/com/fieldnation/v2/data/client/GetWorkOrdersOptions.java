...
public class GetWorkOrdersOptions implements Parcelable {
    ...
    @Json(name = "columns")
    private String _columns = "work_order_id,title,type_of_work,company,location,bundle,pay,schedule,actions,time_logs,status,requests,eta,routes,problems,holds";
