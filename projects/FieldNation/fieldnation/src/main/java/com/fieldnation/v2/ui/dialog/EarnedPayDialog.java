...
public class EarnedPayDialog extends FullScreenDialog {
    ...
    public View onCreateView(LayoutInflater inflater, Context context, ViewGroup container) {
        ...
        _fnToolbarView.getToolbar().setTitle(v.getResources().getString(R.string.earned_pay));
    ...
    public void show(Bundle params, boolean animate) {
        ...
        WorkordersWebApi.getPay(App.get(), _workOrderId, true, WebTransaction.Type.NORMAL);
        populateUi();
    }
