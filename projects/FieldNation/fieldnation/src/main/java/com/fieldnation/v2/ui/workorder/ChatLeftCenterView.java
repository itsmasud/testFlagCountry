...
public class ChatLeftCenterView extends RelativeLayout implements ChatRenderer {
    private static final String TAG = "ChatLeftCenterView";
    ...
    public ChatLeftCenterView(Context context) {
        super(context);
        init();
    }

    public ChatLeftCenterView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatLeftCenterView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_chat_left_center, this, true);
