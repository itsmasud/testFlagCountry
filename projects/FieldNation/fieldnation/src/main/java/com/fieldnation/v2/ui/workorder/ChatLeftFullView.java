...
public class ChatLeftFullView extends RelativeLayout implements ChatRenderer {
    private static final String TAG = "ChatLeftFullView";
    ...
    public ChatLeftFullView(Context context) {
        super(context);
        init();
    }

    public ChatLeftFullView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatLeftFullView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_chat_left_full, this, true);
