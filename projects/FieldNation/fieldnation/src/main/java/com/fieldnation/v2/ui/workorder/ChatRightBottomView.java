...
public class ChatRightBottomView extends RelativeLayout implements ChatRenderer {
    private static final String TAG = "ChatRightBottomView";
    ...
    public ChatRightBottomView(Context context) {
        super(context);
        init();
    }

    public ChatRightBottomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatRightBottomView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_chat_right_bottom, this, true);
