...
public class ChatRightFullView extends RelativeLayout implements ChatRenderer {
    private static final String TAG = "ChatRightFullView";
    ...
    public ChatRightFullView(Context context) {
        super(context);
        init();
    }

    public ChatRightFullView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatRightFullView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_chat_right_full, this, true);
