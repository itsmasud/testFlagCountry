...
public class ChatRightTopView extends RelativeLayout implements ChatRenderer {
    ...
    public ChatRightTopView(Context context) {
        super(context);
        init();
    }

    public ChatRightTopView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatRightTopView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_chat_right_top, this, true);
