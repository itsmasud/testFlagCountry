...
public class InsuranceSummaryView extends RelativeLayout implements WorkOrderRenderer, UUIDView {
    ...
    public InsuranceSummaryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public InsuranceSummaryView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_v2_insurance_fee_summary, this, true);
