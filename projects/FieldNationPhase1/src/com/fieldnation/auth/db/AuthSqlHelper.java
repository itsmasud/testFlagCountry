...
public class AuthSqlHelper extends SQLiteOpenHelper {
	...
	public static final String COLUMN_AUTH_BLOB = "authBlob";
	public static final String[] COLUMNS = { COLUMN_ID, COLUMN_USERNAME, COLUMN_PASSWORD, COLUMN_SECURITY_HASH, COLUMN_AUTH_TOKEN, COLUMN_AUTH_EXPIRY, COLUMN_AUTH_BLOB };

	public AuthSqlHelper(Context context) {
		super(context, "auth.db", null, 5);
	}
